        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td key="id" :props="props">{{
              props.row.payroll_period_from
            }}</q-td>
            <q-td key="id" :props="props">{{
              props.row.payroll_period_to
            }}</q-td>
  ...
  methods: {
    downloadPayslip(data) {
      ...
      setTimeout(() => {
        ...
        window.open(
          "https://payslipapi.sgccserver02.com/payslip/payslipdownload?payslip_id=" +
            data.id
        );
      }, 2000);
      ...
      // axios({
      //   url:
      //     "https://payslip-api.sgccserver02.com/payslip/payslipdownload?payslip_id=" +
      //     id,
      //   method: "GET",
      //   responseType: "blob",
      // }).then((res) => {
